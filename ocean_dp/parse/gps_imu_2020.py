...
types = {1: 'PKT_TYPE_UBX', 2: 'PKT_TYPE_MPU', 3: 'PKT_TYPE_FXS', 4: 'PKT_TYPE_RTC', 5: 'PKT_TYPE_ADC', 6: 'PKT_TYPE_COUNT', 7: 'PKT_TYPE_STRING', 8: 'PKT_TYPE_NMEA'}
    ...
    for fn in netCDFfiles[1:]:
        ...
        with open(fn, "rb") as f:
            ...
            while True:
                ...
                print ('magic 0x%04x type %d N %d seq %d' %(magic, type, N, seq))
                pos = f.tell()
                if magic != 0xAA55:
                    f.seek(-6,1)
                    print('skipping', pos)
