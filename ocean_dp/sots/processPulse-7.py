...
pulse_files = ocean_dp.file_name.find_file_with.find_global(pulse_files, 'deployment_code', 'Pulse-7-2010')
print('pulse files')
...
pulse_files = ocean_dp.file_name.find_file_with.find_files_pattern(os.path.join(path, "netCDF/IMOS*.nc"))
pulse_files = ocean_dp.file_name.find_file_with.find_global(pulse_files, 'deployment_code', 'Pulse-7-2010')
fv01_files = ocean_dp.file_name.find_file_with.find_global(pulse_files, 'file_version', 'Level 1 - Quality Controlled Data')
